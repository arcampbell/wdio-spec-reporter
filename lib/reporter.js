...
class SpecReporter extends events.EventEmitter {
    constructor (baseReporter, config, options = {}) {
        ...
        this.on('runner:end', function (runner) {
            if (this.realtime) {
                console.log(this.context.preface)
                this.printSummaryFooter(runner, this.context.preface)
            } else {
    ...
    printSummaryFooter (runner, preface) {
        console.log(this.getSummaryFooter(runner, preface))
    }
    ...
    getSuiteResult (runner) {
        ...
        output += this.getSummaryFooter(runner, preface)
        return output
    }
